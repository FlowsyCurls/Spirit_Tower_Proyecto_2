...
public class Node : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.name == "Player")
        {
            ...
            if (this.isLavaFloorTrap) {
                ...
                collision.gameObject.GetComponent<PlayerMovement>().lifes--;
    ...
    public void convertToWin ()
    {
        isTraversable = true;
        this.GetComponent<Renderer>().material.color = winCellColor;
        type = "win";
